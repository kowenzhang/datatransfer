...
import datatransfer.gui.extract.TaskTableModel;
 ...
 */
public class SourceExtractPanel extends javax.swing.JPanel implements TaskListener {
    ...
    /** Creates new form SourceStatePanel */
    public SourceExtractPanel(List<DataExtractTask> taskList, int threadNum, int bufferSize) {
        initComponents();
        setSplitDivision();
    ...
    private void initTableModel() {
        TaskTableModel tablemodel = new TaskTableModel(this.taskList.toArray(new DataExtractTask[taskList.size()]));
